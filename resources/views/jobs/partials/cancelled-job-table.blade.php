<div class="bg-white shadow overflow-hidden sm:rounded-lg" id="jobTable">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200 text-center">
                <template x-if="jobs && jobs.length > 0">
                    <template x-for="job in jobs.filter(job => job.status === 'cancelled')" :key="job.id">
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex space-x-2 justify-center">
                                    ...
                                    <button type="button" class="delete-cancel-job-btn text-red-600 hover:text-red-900" title="Delete"
                                            :data-job-id="job.id">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div id="deleteCancelModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50" style="display: none;">
            ...
            <div class="mt-3 text-center">
                ...
                <div class="flex flex-col items-center px-4 py-3 gap-3">
                    <div class="flex justify-center gap-3">
                        <form id="deleteCancelJobForm" action="" method="POST">
                            @csrf
                            @method('DELETE')
                        ...
                        <button id="closeDeleteCancelModal" class="py-2 bg-white text-gray-700 text-base font-medium rounded-md border border-gray-300 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" style="width: 120px;">
                            Cancel
                        </button>
                    </div>
                </div>
